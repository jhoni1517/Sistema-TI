...
| `GEMINI_MODELO` (opcional) | Troca o modelo do Gemini. Padrão: `gemini-3.5-flash-lite` | Nada: usa o padrão |
...
35. `supabase-migracao-orcamento-site.sql`
36. `supabase-migracao-depoimentos.sql`
37. `supabase-migracao-auditoria.sql`
38. `supabase-migracao-retirada.sql`
39. `supabase-migracao-rma.sql`
40. `supabase-migracao-backup.sql`
41. `supabase-corrigir-colunas.sql`
...
Rodar de novo não quebra nada — o arquivo é repetível. O de número 30

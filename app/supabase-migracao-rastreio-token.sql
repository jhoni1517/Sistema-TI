    ...
    case
      ...
      then coalesce((
        select jsonb_agg(jsonb_build_object(
                  ...
                  * dois orçamentos e não apareceu pro cliente". Preço que
                  * não fecha com a lista faz a loja parecer que está
                  * inflando o orçamento — e a página promete, com todas as
                  * letras, que cada opção JÁ É o serviço completo.
                  *
                  * Agora a lista traz tudo que entra na conta, na ordem em
                  * que a loja digitou: mão de obra primeiro, porque é o que
                  * a OS é, e o desconto por último, porque ele é o abate.
                  */
                 'itens', (
